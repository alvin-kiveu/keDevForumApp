...
class DevitControler extends Controller
{
    ...
    {
           $devitid = htmlentities($request->input('devitid'), ENT_QUOTES, 'UTF-8');
          $userDevKdfId = htmlentities($request->input('userKdfId'), ENT_QUOTES, 'UTF-8');
           $divitype = htmlentities($request->input('divitype'), ENT_QUOTES, 'UTF-8');
    ...
    public function devitComment(Request $request)
    {
          $devitid = htmlentities($request->input('devitid'), ENT_QUOTES, 'UTF-8');
          $userDevKdfId = htmlentities($request->input('userKdfId'), ENT_QUOTES, 'UTF-8');
          $devitcomment = htmlentities($request->input('devitcomment'), ENT_QUOTES, 'UTF-8');
    ...
    {
        $userDevAdded = strip_tags(htmlentities($request->input('userDevAdded'), ENT_QUOTES, 'UTF-8'));
        $userDevAdder = strip_tags(htmlentities($request->input('userDevAdder'), ENT_QUOTES, 'UTF-8'));
    ...
    {
        $userDevAdded = strip_tags($request->input('userDevAdded'));
$userDevAdder = strip_tags($request->input('userDevAdder'));
