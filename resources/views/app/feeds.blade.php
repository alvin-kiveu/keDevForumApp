 ...
 <div class="col-lg-8">
                    <div class="card mb-3 shadow fade-hover  bounce">
                        <div class="card-header">
                            ...
                            <div class="col">
                                ...
                                <div class="avatar avatar-2xl status-online">
                                    <img class="rounded-circle" src="https://umeskiasoftwares.com/images/umeskia_s.png" alt="" />
                                </div>
                                <div class="flex-1 align-self-center ms-2">
                                    <p class="mb-1 lh-1"><a class="fw-semi-bold" href="#">Umeskia</a></p>
                                    <p class="mb-0 fs--1">14 Feb &bull; Nairobi&bull; <span class="fas fa-globe-americas"></span></p>
                                </div>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-truncate" style="max-height: 3.6em;">This will apply the ellipsis truncation to any p element </p>
                        ...
                        <div class="card-header">
                            ...
                            <div class="col">
                                ...
                                <div class="avatar avatar-2xl status-offline">
                                    <img class="rounded-circle" src="https://qph.cf2.quoracdn.net/main-thumb-1265164455-50-oufqkxrfojwectcfvdswfwtnqpxqdtnu.jpeg" alt="" />
                                </div>
                                <div class="flex-1 align-self-center ms-2">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <div class="col">
                                <div class="d-flex">
                                <div class="avatar avatar-2xl status-online">
                                    <img class="rounded-circle" src="https://avatars.githubusercontent.com/u/99127888?v=4" alt="" />
                                </div>
                                <div class="flex-1 align-self-center ms-2">
